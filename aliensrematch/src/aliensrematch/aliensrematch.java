...
public class aliensrematch {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 4; i++){
			...
			System.out.println(bot1returnSteps);
			...
			System.out.println(bot2returnSteps);
			...
			System.out.println(bot3returnSteps);
			...
			System.out.println(bot6returnSteps);
