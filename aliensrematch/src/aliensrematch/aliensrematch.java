...
public class aliensrematch {
	public static void main(String[] args) {
		...
		for (int i = 0; i < iters; i++) {
			...
			bot5 bot5 = new bot5(5, 0.05);
			int[] ret5 = new int[2];
			ret5 = bot5.run();*/
			
			System.out.println("bot6");
			bot6 bot6 = new bot6(1, 0.05);
			int[] ret6 = new int[2];
			ret6 = bot6.run(); 
			System.out.println("bot7");
			bot7 bot7 = new bot7(1, 0.05);
			int[] ret7 = new int[2];
			ret7 = bot7.run();
			
			/*System.out.println("bot7");
			bot8 bot8 = new bot8(5, 0.05);
			int[] ret8 = new int[2];
			ret8 = bot8.run();
		...
		System.out.println("Bot 5 saved " + saved5 + " crew and took an average of " + sumsteps5 / iters + " steps and took an average of "
				+ ran5 / iters + " random moves");
		...
		System.out.println("Bot 8 saved " + saved8 + " crew and took an average of " + sumsteps8 / iters + " steps and took an average of "
				+ ran8 / iters + " random moves");
		System.out.println("Bot 9 saved " + saved9 + " crew and took an average of " + sumsteps9 / iters + " steps and took an average of "
				+ ran9 / iters + " random moves");
