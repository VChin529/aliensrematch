...
public class aliensrematch {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 System.out.println("Bot1 Saved:"); System.out.println(ret1[0]);
		...
		bot4 bot4 = new bot4(3, 0.75);
		int[] ret4 = new int[2];
		ret4 = bot4.run();

		System.out.println("Bot4 Saved:");
		System.out.println(ret4[0]);
		System.out.println("Bot4 Steps:");
		System.out.println(ret4[1]);
		
		/*
		
		bot5 bot5 = new bot5(4, 0.5);
		int[] ret5 = new int[2];
		ret5 = bot5.run();

		System.out.println("Bot5 Saved:");
		System.out.println(ret5[0]);
		System.out.println("Bot5 Steps:");
		System.out.println(ret5[1]);*/
		...
		// TEST COMPARISON
		  ...
		  + sumsteps3/100 + " steps"); System.out.println("Bot 4 saved " + saved4 +
