...
// simulated anealling
    public class bot9 {
        ...
        public bot9(int k, double alpha) {
        ...
        Stack<cell> findPath() {
            ...
            while (!queue.isEmpty()) {
                ...
                if ((curr.up != null) && (curr.up.state) && (!queue.contains(curr.up)) && (curr.up != null)
                    ...
                    if (d != 0 && Math.random() <= (Math.pow((1.0- curr.up.palien),0.25))) {
                        queue.add(curr.up);
                        ct++;
                    }
                }
                ...
                if ((curr.down != null) && (curr.down.state) && (!queue.contains(curr.down))
                    ...
                    if (d != 0 && Math.random() <= (Math.pow((1.0- curr.down.palien),0.25))) {
                        queue.add(curr.down);
                        ct++;
                    }
                }
                ...
                if ((curr.left != null) && (curr.left.state) && (!queue.contains(curr.left))
                    ...
                    if (d != 0 && Math.random() <= (Math.pow((1.0- curr.left.palien),0.25))) {
                        queue.add(curr.left);
                        ct++;
                    }
                }
                ...
                if ((curr.right != null) && (curr.right.state) && (!queue.contains(curr.right))
                    ...
                    if (d != 0 && Math.random()<= (Math.pow((1.0- curr.right.palien),0.25))) {
                        queue.add(curr.right);
                        ct++;
                    }
                }
        ...
        cell findMaxCrew() {
            ...
            cell temp = ret;
            double maxProb = 0.0;
            if (ret.up!=null && !ret.up.state) {
                if (ret.up.pcrew > maxProb) {
                    temp = ret.up;
                    maxProb = ret.up.pcrew;
                }
            }
            if (ret.down!=null && !ret.down.state) {
                if (ret.down.pcrew > maxProb) {
                    temp = ret.down;
                    maxProb = ret.down.pcrew;
                }
            }
            if (ret.left!=null && !ret.left.state) {
                if (ret.left.pcrew > maxProb) {
                    temp = ret.left;
                    maxProb = ret.left.pcrew;
                }
            }
            if (ret.right!=null && !ret.right.state) {
                if (ret.right.pcrew > maxProb) {
                    temp = ret.right;
                    maxProb = ret.right.pcrew;
                }
            }

            if (Math.random() < 0.5*temp.pcrew) {
                ret = temp;
                ct++;
            }
